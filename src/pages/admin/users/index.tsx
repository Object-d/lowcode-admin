...
import { Button, Divider, message, Tag, Popconfirm, Select, Space, Dropdown, Menu } from 'antd';
...
import { queryUser, updateUser, createUser, removeUser, showUser } from '@/services/admin/user';
    ...
    <PageContainer>
        ...
        >
          <ProTable<UserListItem, UserListItem>
            ...
            form={{
              ...
              initialValues: {
                ...currentRow,
                permissions: (currentRow as UserListItem).permissions?.map((row) => row.id),
      ...
      {currentRow && Object.keys(currentRow).length ? (
        <ShowForm
          ...
          values={{
            ...currentRow,
            permissions: (currentRow as UserListItem).permissions?.map((row) => row.name),
